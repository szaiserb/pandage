...
import PyQt5.QtCore # pyqtSignal

class WithQt:

    def __init__(self, title=None, parent=None, gui=True, QtGuiClass=None, **kwargs):
...
def get_QtGuiClass(Ui_Window):

    class QtGuiClass(PyQt5.QtWidgets.QMainWindow, Ui_Window):
